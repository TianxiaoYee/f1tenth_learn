...
(cl:defmethod cl:initialize-instance :after ((m <scan_range>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'scan_range)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ytx_lab1-msg:<scan_range> is deprecated: use ytx_lab1-msg:scan_range instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <scan_range>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ytx_lab1-msg:header-val is deprecated.  Use ytx_lab1-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'closest_point-val :lambda-list '(m))
(cl:defmethod closest_point-val ((m <scan_range>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ytx_lab1-msg:closest_point-val is deprecated.  Use ytx_lab1-msg:closest_point instead.")
  (closest_point m))

(cl:ensure-generic-function 'farthest_point-val :lambda-list '(m))
(cl:defmethod farthest_point-val ((m <scan_range>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ytx_lab1-msg:farthest_point-val is deprecated.  Use ytx_lab1-msg:farthest_point instead.")
  (farthest_point m))
